...
\renewcommand*{\afterpartskip}{\clearpage\hbFullPageArtHook{\hbPartSubcover}\twocolumn}
...
% Back cover page
\newcommand{\hbBackcover}{assets/cover}
\newcommand{\hbBackcoverHeader}{Header. Renew me!}
\newcommand{\hbBackcoverClose}{Closing sentence. Renew me!}
\newcommand{\hbBackcoverContent}{Content. Renew me!}
\newcommand{\hbBackcoverLink}{\url{https://example.org}}
\newcommand{\hbBackcoverLogo}{assets/dnd-logo-initials}
...
\newcommand{\hbMakeBackcover}{%
  ...
  \begin{multicols*}{2}
    ...
    \begin{flushleft}%
      ...
      \fillstroke{[1]}{[0]}{.5}{\textbf{\hbBackcoverContent}}%
      \end{flushleft}%
    \begin{center}
    ...
    \end{center}
    \begin{tb*}{\paperwidth}{0pt}{0pt}%
      \includegraphics[width=\paperwidth,height=\paperheight]{\hbBackcover}
    \end{tb*}%
    \begin{tb*}{\paperwidth}{0pt}{0pt}%
      \includegraphics[width=0.55\paperwidth,height=\paperheight]{assets/backcover}
    \end{tb*}%
  \end{multicols*}
  \clearpage%
}
